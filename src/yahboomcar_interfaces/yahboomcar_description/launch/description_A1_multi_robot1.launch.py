...
def generate_launch_description():
    ...
    if camera_type == 'usb':
        default_model_path = urdf_tutorial_path / 'urdf/yahboomcar_A1_robot1_usb.urdf.xacro'
    else:
        default_model_path = urdf_tutorial_path / 'urdf/yahboomcar_A1_robot1.urdf.xacro'
