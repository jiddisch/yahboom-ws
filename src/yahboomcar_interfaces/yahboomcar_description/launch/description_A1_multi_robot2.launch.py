...
def generate_launch_description():
    ...
    if camera_type == 'usb':
        default_model_path = urdf_tutorial_path / 'urdf/yahboomcar_A1_robot2_usb.urdf.xacro'
    else:
        default_model_path = urdf_tutorial_path / 'urdf/yahboomcar_A1_robot2.urdf.xacro'
