...
class LineDetect(Node):
	def __init__(self, name):
		...
		self.Mouse_XY = (0, 0)
		self.hsv_text = "/root/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_astra/yahboomcar_astra/colorfollowHSV.text"
	...
	def on_timer(self):
		...
		start = time.time()
		fps = 1 / (start - self.end) if self.end != 0 else 0
		self.end = start
