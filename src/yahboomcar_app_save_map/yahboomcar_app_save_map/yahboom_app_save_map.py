from yahboomcar_web_savmap_interfaces.srv import WebSaveMap                                                            
...
class MinimalService(Node):
    ...
    def add_three_ints_callback(self, request, response):
        ...
        map_path = "/root/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_nav/maps/" + map_name
        ...
        try:
            conn = sqlite3.connect("/root/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_app_save_map/yahboomcar_app_save_map/xgo.db")
            c = conn.cursor()
