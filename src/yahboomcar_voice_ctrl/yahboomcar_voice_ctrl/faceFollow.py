...
class faceFollow(Node):
    def __init__(self,name):
        ...
        self.encoding = ['8UC3']
        xml_path = os.path.join(get_package_share_directory('yahboomcar_astra'),'config','haarcascade_frontalface_default.xml')
    ...
    def declare_param(self):
        # limit
        self.declare_parameter("mintra_r",200.0)
        ...
        self.declare_parameter("tolerance_r",45.0)
        ...
        self.declare_parameter("angular_Kp",12.5)
        ...
        self.scale = 1000
        # servo init
        self.declare_parameter("Servo_Kp",18.0)
        ...
        self.declare_parameter("Servo_Kd",2.5)
    ...
    def on_timer(self):
        if self.frame is not None:
            ...
            faces = self.face_patterns.detectMultiScale(self.frame , scaleFactor=1.2, minNeighbors=10, minSize=(50, 50))
            if len(faces) == 1:
                ...
                text = "x:" + str(self.Center_x) + " y:" + str(self.Center_y)+ " area:" + str(self.Center_r)
    ...
    def execute(self, x, y, z=None):
        ...
        linear_Pid = max(-0.45, min(linear_Pid, 0.8)) 
