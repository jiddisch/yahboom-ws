...
class faceTracker(Node):
    ...
    def declare_param(self):
        # PID
        self.declare_parameter("Kp",18.0)
    ...
    def on_timer(self):
        if self.frame is not None:
            ...
            faces = self.face_patterns.detectMultiScale(self.frame , scaleFactor=1.2, minNeighbors=10, minSize=(65, 65))
            if len(faces) == 1:
    ...
    def execute(self, point_x, point_y):
        ...
        #print(f"PWMServo_X: {self.PWMServo_X}, PWMServo_Y: {self.PWMServo_Y}")
        self.pub_Servo.publish(self.servo_angle)
