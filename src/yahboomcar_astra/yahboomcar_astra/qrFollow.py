...
class qrFollow(Node):
    ...
    def on_timer(self):
        ...
        if processed_frame is not None: 
            ...
            now_time = time.time()
            if now_time - self.prev_time > 0.5:
    ...
    def execute(self, x, y, z=None):
        ...
        linear_Pid = max(-0.45, min(linear_Pid, 0.32)) 
        ...
        #print(f"linear_Pid {linear_Pid}, angular_Pid {angular_Pid}, Servoy_Pid {Servoy_Pid}, Servox_Pid {Servox_Pid}")
