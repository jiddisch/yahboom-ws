...
class gestureFollow(Node):
    ...
    def declare_param(self):
        ...
        self.declare_parameter("tolerance_r",150.0)
        ...
        self.declare_parameter("angular_Kp",30.0)
        ...
        self.scale = 1000
        # servo init
        self.declare_parameter("Servo_Kp",20.0)
    ...
    def on_timer(self):
        ...
        if len(self.hand_detector.lmList) != 0:
            ...
            if self.hand_detector.get_gesture() == "Zero":
                cv.putText(frame, "STOP", (300, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 4)
                #  self.execute(320, 240,self.mintra_r)
                self.pub_cmdVel.publish(Twist())
            else:
                 cv.putText(frame, "RUN", (300, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (100, 200, 200), 4)
