...
class color_Tracker(Node):
    def __init__(self,name):
        ...
        self.hsv_text = "/home/root/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_voice_ctrl_depth/yahboomcar_voice_ctrl_depth/colorHSV.text"
        self.hsv_lines = []
        try:
    ...
    def depth_img_Callback(self,color_frame,depth_frame):
        ...
        result_frame, binary= self.process(result_image)
        ...
        if self.Center_r > 5:
            ...
            if valid_depths:
                ...
                dist = 0
            text = "x:" + str(int(self.x)) + " y:" + str(int(self.y))+ " dist:" + str(dist)
        ...
        if len(binary) != 0: 
            cv.imshow('frame', ManyImgs(1, ([result_frame, binary])))
        else:
    ...
    def process(self, rgb_img):
        ...
        if len(self.hsv_range) != 0:
            ...
            if self.circle[2] != 0:
                self.x = self.circle[0]
                self.y = self.circle[1]
    ...
    def execute(self, point_x, dist):
        ...
        # self.get_logger().info(f'x={point_x}, dist={dist}')
