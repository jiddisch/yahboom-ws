...
class apriltagTracker(Node):
    ...
    def declare_param(self):
        ...
        self.declare_parameter("angular_Kp",1.3)
    ...
    def get_param(self):
        ...
        self.angular_pid.update_params(self.angular_Kp*10.0/self.scale, self.angular_Ki*10.0/self.scale, self.angular_Kd*10.0/self.scale)
        self.minDist = self.minDistance * 1000
