...
class poseTracker(Node):
    ...
    def declare_param(self):
        ...
        self.declare_parameter("minDistance",1.2)
    ...
    def depth_img_Callback(self,color_frame,depth_frame):
        ...
        result_image, pose_points, center_r= self.pose_detector.pubPosePoint(result_image)
        ...
        if pose_points:  
            ...
            cv.circle(result_image, (int(center_x),int(center_y)), 10, (0, 255, 255), -1)
            if 3 < int(center_y) and int(center_y) < 477 and 3 < int(center_x) and int(center_x) < 637:
                points = [
                        (int(center_y), int(center_x)),         # 中心点
                        (int(center_y +3), int(center_x +3)),  # 右下偏移点
                        (int(center_y -3), int(center_x -3))   # 左上偏移点
                    ]
                valid_depths = []
                for y, x in points:
                ...
                text = "x:" + str(int(center_x)) + " y:" + str(int(center_y))+ " dist:" + str(int(dist))
